...
class CliOperations[T: Base, ResponseT: BaseModel, CreateT: BaseModel]:
    ...
    def register_get_row(self) -> None:
        ...
        def command(
            ...
            try:
                row = self.sync_oper.get_row(row_id=parse_row_id(row_id))
    ...
    def register_get_row_or_none(self) -> None:
        ...
        def command(
            ...
            try:
                row = self.sync_oper.get_row_or_none(row_id=parse_row_id(row_id))
                if row is None:
    ...
    def register_lookup_by_id_or_name(self) -> None:
        ...
        def command(
            ...
            try:
                ...
                row = self.sync_oper.lookup_by_id_or_name(row_id=parsed_id, name=name)
    ...
    def register_update_row(self) -> None:
        ...
        def command(
            ...
            try:
                row = self.sync_oper.update_row(row_id=parsed_id, **update_data)
            ...
            if from_file:
                try:
                    ...
                    try:
                        ...
                        if unexpected(not isinstance(parsed, list)):
